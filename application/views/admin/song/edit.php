  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form id="songsfrm" action="<?php echo base_url(); ?>admin/Songs/update" enctype="multipart/form-data" method="POST">
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="fileupload">Upload <label class="serror">*</label></label>
