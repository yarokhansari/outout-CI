  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form id="categoryfrm" action="<?php echo base_url(); ?>admin/Category/update" enctype="multipart/form-data" method="POST">
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="categoryname" name="categoryname" class="form-control" value="<?php echo $info[0]['name']; ?>">
                </div>
                <div class="form-group">
